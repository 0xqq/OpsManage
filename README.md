...
## OpsManage功能说明
![image](https://github.com/ArchitecTang/OpsManage/blob/master/demo_imgs/opsmanage.png)
## 安装效果图
...
## 部分功能截图:
Ansible部署功能：
![image](https://github.com/ArchitecTang/OpsManage/blob/master/demo_imgs/ansible.gif)

代码部署：
![image](https://github.com/ArchitecTang/OpsManage/blob/master/demo_imgs/project.gif)

资产管理：
![image](https://github.com/ArchitecTang/OpsManage/blob/master/demo_imgs/assets.gif)

计划任务管理：
![image](https://github.com/ArchitecTang/OpsManage/blob/master/demo_imgs/crontab.gif)

全局配置：
![image](https://github.com/ArchitecTang/OpsManage/blob/master/demo_imgs/config.gif)

用户管理：
![image](https://github.com/ArchitecTang/OpsManage/blob/master/demo_imgs/user.gif)
